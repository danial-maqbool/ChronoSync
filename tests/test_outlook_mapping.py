...
@pytest.mark.parametrize('rule,expected',[
 ...
 ('FREQ=WEEKLY;BYDAY=MO,TU,WE,TH,FR',{'RecurrenceType':1,'DayOfWeekMask':62}),
 ('FREQ=MONTHLY;BYDAY=1TU',{'RecurrenceType':3,'DayOfWeekMask':4,'Instance':1}),
...
def test_reject_before_write():
    with pytest.raises(ValueError): outlook_recurrence('FREQ=MONTHLY;BYSETPOS=2')
