...
doc = Document()
doc.add_heading("Synthetic university course outline", 0)
for line in examples()[0][1].splitlines():
    doc.add_paragraph(line)
doc.save(target / "course-outline.docx")
pdf = pymupdf.open()
page = pdf.new_page()
page.insert_textbox(
    (60, 60, 535, 700), "SYNTHETIC COURSE OUTLINE\n\n" + examples()[0][1], fontsize=13
)
pdf.save(target / "course-outline.pdf")
(target / "interview.eml").write_text(
